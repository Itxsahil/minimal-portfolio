...
export const metadata = createArticleMetadata({
  ...
  description: 'A personal reflection on rediscovering the habit of reading and writing.',
  pathname: '/b/1',
})

# Trying to Find My Words Again
<p className="text-sm text-gray-400 dark:text-gray-500 mb-8 font-mono">Oct 8, 2025</p>
