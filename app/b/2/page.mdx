export const metadata = {
  ...
  openGraph: {
    images: [
      {
        url: "/api/og?title=6%20Sneaky%20JavaScript%20Patterns%20to%20Cut%20Boilerplate",
        width: 1200,
        height: 630,
      },
    ],
...
# observability
<p className="text-sm text-gray-400 dark:text-gray-500 mb-8 font-mono">Jul 24, 2025</p>
